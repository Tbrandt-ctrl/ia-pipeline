        ...
        Tokenizer.prototype.write = function (input) {
            try {
                ...
                for (var i = 0; i < buffer.length; i += 1) {
                    ...
                    throw new TokenizerError("Unexpected \"".concat(String.fromCharCode(n), "\" at position \"").concat(i, "\" in state ").concat(TokenizerStates[this.state]));
                }
    ...
    var TokenParser = /** @class */ (function () {
        ...
        TokenParser.prototype.write = function (token, value) {
            try {
                ...
                throw new TokenParserError("Unexpected ".concat(exports.TokenType[token], " (").concat(JSON.stringify(value), ") in state ").concat(TokenParserState[this.state]));
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
            }
            catch (err) {
                this.error(err);
